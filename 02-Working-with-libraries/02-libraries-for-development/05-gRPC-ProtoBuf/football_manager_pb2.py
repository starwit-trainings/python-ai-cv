...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'football_manager_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_CLUBREQUEST']._serialized_start=98
